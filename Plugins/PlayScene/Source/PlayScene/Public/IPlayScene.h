...
public:
	...
	*/
	virtual TWeakObjectPtr<UTextureRenderTarget2D> GetTextureRenderTarget2D(FString ClientName) = 0;

	/**
	* Set UTextureRenderTarget2D to TWeakObjectPtr
	* This is abstract fucntion and it need to be implemened
	*/
	virtual void SetTextureRenderTarget2D(FString ClientName, UTextureRenderTarget2D* TexRenderTarget2D) = 0;
};
