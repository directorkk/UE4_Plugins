...
public:
	...
	*/
	...
	void SetClientName(FString ClientName);
...
{
public:
	FPlaySceneSlate(FString ClientName, FVector2D ClientSize, FVector2D ClientPosition);
	~FPlaySceneSlate();

public:
	static void Initialize(FString ClientName, FVector2D ClientSize, FVector2D ClientPosition);
	static void Shutdown(FString ClientName);
	static void Shutdown();

private:
	TSharedPtr<SWindow> PlaySceneWindow;
	FString PlaySceneWindowName;
...
private:
	...
	static TSharedPtr<TMap<FString, TSharedPtr<FPlaySceneSlate>>> gMapPlaySceneSlate;
};